...
// page in pdf file: 6(A). New sidebar.
                ...
                <div class="sidebar-item">
                    <div class="sidebar__more-about">
                        ...
                        <a class="btn-icon less">
                            ...
                            <br>
                            <span class="text">Arthritis</span><br>
					    </a>
                        <a class="btn-icon less">
                            <br>
                            <span class="icon">
                            ...
                            <br>
                            <span class="text">Back Pain</span><br>
					    </a>
                        <a class="btn-icon less">
                            <br>
                            <span class="icon">
                            ...
                            <br>
                            <span class="text">Headache & Migraine</span><br>
					    </a>
                        <a class="btn-icon less">
                            <br>
                            <span class="icon">
                            ...
                            <br>
                            <span class="text">Trigeminal Neuralgia</span><br>
					    </a>
                        </div>
                    </div>
                </div>    
