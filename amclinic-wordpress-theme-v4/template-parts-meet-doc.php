...
// Template Name: Template Part Meet Doc
...
// page in pdf file: 18(D). New sidebar. The same in page 19 (The Clinic - Photos).
            ...
            <div class="col-xs-12 col-md-3">
                <div class="sidebar-item">
                    <div class="sidebar__more-about">
                        <h6 class="sidebar-title">Specialist In</h6>
                        <div class="btns-container">
                        <a class="btn-icon less white">
                            <br>
                            <span class="icon">
                            <br>
                            ...
                            <br>
                            <span class="text">Women’s Health</span><br>
					    </a>
                        <a class="btn-icon less white">
                            <br>
                            <span class="icon">
                            ...
                            <br>
                            <span class="text">Dermatology</span><br>
					    </a>
                        <a class="btn-icon less white">
                            <br>
                            <span class="icon">
                            ...
                            <br>
                            <span class="text">Men’s Health</span><br>
					    </a>
                        <a class="btn-icon less white">
                            <br>
                            <span class="icon">
                            ...
                            <br>
                            <span class="text">Fertility</span><br>
					    </a>
                        <a class="btn-icon less white">
                            <br>
                            <span class="icon">
                            ...
                            <br>
                            <span class="text">Acupuncture & Chinese Herbal Consultation</span><br>
					    </a>
                        <a class="btn-icon less white">
                            <br>
                            <span class="icon">
                            ...
                            <br>
                            <span class="text">Chinese Herbal Consultation</span><br>
					    </a>
                        </div>
                    </div>
                </div>    
